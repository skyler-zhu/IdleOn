...
namespace IdleOnLike.UI
{
    ...
    {
        public static void Build(GameCatalog catalog, Action<CharacterDefinition> onCharacterSelected)
        {
            ...
            var subtitle = RuntimeUiFactory.CreateText(root, "Subtitle", "The second slot is ready for another character when you add one.", 20, TextAnchor.MiddleCenter, new Color(0.75f, 0.80f, 0.88f));
            ...
            for (var i = 0; i < characters.Count; i++)
            {
                ...
                var roleText = RuntimeUiFactory.CreateText(card, "Role", character.Role.ToString(), 18, TextAnchor.MiddleCenter, new Color(0.80f, 0.86f, 0.92f));
                ...
                var button = RuntimeUiFactory.CreateButton(card, "Select Button", "Start", new Color(0.24f, 0.45f, 0.85f, 1f));
