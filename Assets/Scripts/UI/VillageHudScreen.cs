...
namespace IdleOnLike.UI
{
    public static class VillageHudScreen
    {
        public static void Build(GameRuntime runtime, Action onGoForestRequested, Action onMineCaveRequested, Action onCharacterSelectRequested, Action onNewGameRequested)
        {
            ...
            RuntimeUiFactory.SetRect(inventoryButton.GetComponent<RectTransform>(), new Vector2(0.45f, 0.16f), new Vector2(0.55f, 0.84f), Vector2.zero, Vector2.zero);
            ...
            RuntimeUiFactory.SetRect(offlineButton.GetComponent<RectTransform>(), new Vector2(0.56f, 0.16f), new Vector2(0.66f, 0.84f), Vector2.zero, Vector2.zero);
            ...
            RuntimeUiFactory.SetRect(charactersButton.GetComponent<RectTransform>(), new Vector2(0.68f, 0.16f), new Vector2(0.82f, 0.84f), Vector2.zero, Vector2.zero);
            ...
            RuntimeUiFactory.SetRect(newGameButton.GetComponent<RectTransform>(), new Vector2(0.84f, 0.16f), new Vector2(0.98f, 0.84f), Vector2.zero, Vector2.zero);
